...
CREATE TRIGGER product_p_click_count_TRG
BEFORE INSERT ON product
FOR EACH ROW
BEGIN
IF :NEW.p_click_count IS NOT NULL THEN
  SELECT product_p_click_count_SEQ.NEXTVAL INTO :NEW.p_click_count FROM DUAL;
END IF;
END;
