...
public class UserRestController {
	...
	@LoginCheck
	@GetMapping("/{userId}")
	public ResponseEntity<Response> user_view(@PathVariable(name = "userId") String userId, HttpSession session)
			throws Exception {
	...
	public ResponseEntity<Response> user_password_mismatch_handler(PasswordMismatchException e) {
		Response response = new Response();
