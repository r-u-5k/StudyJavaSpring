...
public class StudentDaoMapperInterfaceMain {
	...
	public static void main(String[] args) {
		...
		/**************************************************
		 * 1. SELECT[결과타입이 DTO[DTO List] 객체인 경우]
		 **************************************************/
		/*
		 resultType :  DTO
		 */
		...
		System.out.println(mapperInterfaceStudentDao.findStudentByIdResultMap(2));
		System.out.println("---------findAllStudentsResultMap--------------------");
		System.out.println(mapperInterfaceStudentDao.findAllStudentsResultMap());

		/**************************************************
		 * 2. SELECT[결과타입이 Wrapper(String)[Wrapper(String) List]객체인 경우]
		 **************************************************/
		System.out.println("---------findStudentByIdResultMap--------------------");
		System.out.println("---------findAllStudentsResultMap--------------------");
		/**************************************************
		...
		System.out.println(mapperInterfaceStudentDao.findStudentByIdWithAddress(4));
		...
		*/
		...
		int insertRowCount = mapperInterfaceStudentDao.insertStudentBySequence(
				Student.builder().studId(1234).name("시퀀스1").phone("100-10000").email("kim1@naver.com").dob(new Date()).build());
		...
		Student insertStudent = 
				Student.builder().studId(9000).name("시퀀스2").phone("200-20000").email("kim2@naver.com").dob(new Date()).build();
