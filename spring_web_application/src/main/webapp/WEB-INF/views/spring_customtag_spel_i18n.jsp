...
<body>
	...
	@Bean("messageSource") public MessageSource messageSource() {
	...
	<< user_en.properties>>
		nv.bc=HOME < {0} < {1}
	 -->
		<li><s:message code="nv.bc" arguments="user,list"
				argumentSeparator="," /> <%--	           
	 ...
	 --%></li>
		...
		<li><s:eval
				expression="@messageSource.getMessage('nv.bc',new Object[]{'유저','리스트'},new java.util.Locale('en','US'))" /></li>
